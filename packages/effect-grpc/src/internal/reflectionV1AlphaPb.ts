...
// by `protoc-gen-es` from the canonical `grpc/reflection/v1alpha/reflection.proto`
// (Copyright 2016 The gRPC Authors, Apache-2.0). The protocol is frozen, so the
// descriptor is vendored instead of generated at build time.
...
export type ServerReflectionRequest =
  Message<"grpc.reflection.v1alpha.ServerReflectionRequest"> & {
     ...
     * defined field and responds with the corresponding message.
     *
...
}> /*@__PURE__*/ = serviceDesc(file_grpc_reflection_v1alpha_reflection, 0);
