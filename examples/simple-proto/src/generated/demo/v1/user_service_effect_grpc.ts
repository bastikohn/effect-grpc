...
const makeUserServiceClient = Effect.gen(function* () {
  const client = yield* RpcClient.make(UserServiceRpcGroup, { flatten: true });
  return {
...
export class UserServiceClient extends Context.Tag("demo.v1.UserService/UserServiceClient")<UserServiceClient, UserServiceClientService>() {
  static readonly make = makeUserServiceClient;
}

export const UserServiceClientLayer = Layer.scoped(UserServiceClient, UserServiceClient.make);
